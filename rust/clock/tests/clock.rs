...
fn test_clock_from_string() {
    assert_eq!(Clock::from("12:3".to_string()), Clock::new(12, 3));
    assert_eq!(Clock::from("07:08".to_string()), Clock::new(7, 8));
    assert_eq!(Clock::from("26:121".to_string()), Clock::new(4, 1));
}
